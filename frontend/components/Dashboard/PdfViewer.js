                                    ...
                                    {!isSelecting && selection.w > 20 && (
                                        <motion.div initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="absolute -top-14 left-1/2 -translate-x-1/2 flex gap-1.5 p-1.5 bg-white backdrop-blur-3xl border border-slate-200 shadow-2xl rounded-3xl pointer-events-auto items-center">
                                            ...
                                            <div className="relative">
                                                <button 
                                                    onClick={() => setShowOptionsScroll(!showOptionsScroll)} 
                                            ...
                                            <button 
                                                onClick={() => { onScanSelection?.(captureCrop()); setSelection(null); }} 
                                                className="selection-btn group/scanbtn flex items-center gap-2 bg-emerald-50 text-emerald-600 border border-emerald-100 hover:bg-emerald-100 px-5 py-2.5 rounded-2xl text-[10px] font-black transition-all active:scale-95 shadow-sm"
                                            >
                                                <Zap size={13} className="group-hover/scanbtn:scale-125 transition-transform" /> SCAN AREA
                                            </button>
