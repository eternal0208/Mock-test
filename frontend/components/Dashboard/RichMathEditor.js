            ...
            <div className={`rounded-xl border border-slate-200 bg-white overflow-hidden ${className}`}>
                ...
                <div className="relative">
                    <textarea
                        ...
                        style={{ padding: '8px 40px 8px 10px', minHeight: `${rows * 24}px` }}
                    />
                    {/* Σ toggle button */}
                    <button
                        type="button"
                        ...
                        className={`absolute top-2 right-2 w-7 h-7 rounded-md flex items-center justify-center text-sm font-bold transition-colors ${
                            showSymbols
                ...
                {/* Symbol strip — full width grid, shown when toggled */}
                {showSymbols && (
                    <div className="border-t border-slate-100 bg-slate-50 px-2 py-2 flex flex-wrap gap-1 w-full">
                        {QUICK_SYMBOLS.map((s, i) => (
                            <button
                                ...
                                title={s.l}
                                onClick={() => {
                                    // Insert LaTeX at cursor position inside the textarea
